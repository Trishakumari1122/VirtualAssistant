...
try {
 ...
 <form className='w-[70%] h-[500px] max-w-[500px] bg-[#403f3f62] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
...
<button className='min-w-[140px] h-[50px] mt-[30px] text-black font-semibold  bg-white rounded-full text-[19px] ' disabled={loading}>{loading?"Loading...":"Sign Up"}</button>
